...
public class calServlet extends HttpServlet {
    ...
    throws ServletException, IOException {        
        String get_a = request.getParameter("a");
        String get_b = request.getParameter("b");
        String get_o = request.getParameter("o");
        double a,b;
        PrintWriter web=response.getWriter();
        try{
            a=Double.parseDouble(get_a);
            b=Double.parseDouble(get_b);   
            web.println(cald(a, b, get_o));            
        }catch(Exception e){
            System.out.println(e);
        }
        
    }
    private String cald(double a,double b,String o){
        if(o.equals("+")){
            return ("result: "+(a+b));
        }
        else if(o.equals("-")){
